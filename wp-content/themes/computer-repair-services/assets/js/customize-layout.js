...
(function( $ ) {
	...
	*/
		...
		function computer_repair_services_customizer_label( id, title ) {
			...
			if ( id === 'computer_repair_services_slider_loop' || id === 'computer_repair_services_email_text' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-computer_repair_services_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
	...
	*/
		...
		//Slider
		computer_repair_services_customizer_label( 'computer_repair_services_slider_loop', 'Slider' );
