<?php
    ...
    if($computer_repair_services_scroll_to_top_border_radius != false){
        $computer_repair_services_theme_css .='#colophon a#button{';
            $computer_repair_services_theme_css .='border-radius: '.esc_attr($computer_repair_services_scroll_to_top_border_radius).'px;';
        $computer_repair_services_theme_css .='}';
    }
