...
<!-- wp:column {"width":"50%"} -->
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:group {"style":{"spacing":{"padding":{"top":"20px","bottom":"20px","left":"10px","right":"10px"}},"border":{"radius":"5px","width":"5px"}},"backgroundColor":"custom-color-2","borderColor":"custom-color-1","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color has-custom-color-1-border-color has-custom-color-2-background-color has-background" style="border-width:5px;border-radius:5px;padding-top:20px;padding-right:10px;padding-bottom:20px;padding-left:10px"><!-- wp:query-title {"type":"search"} /--></div>
<!-- /wp:group -->

<!-- wp:template-part {"slug":"archives","tagName":"main"} /--></div>
<!-- /wp:column -->
